...
func (server *Server) getAccount(ctx *gin.Context) {
	...
	account, err := server.isAccountOwnedByUser(ctx, req.ID)
	if err != nil {
		return
	}
...
func (server *Server) updateAccount(ctx *gin.Context) {
	...
	_, err := server.isAccountOwnedByUser(ctx, req.ID)
	if err != nil {
		return
	}
...
func (server *Server) isAccountOwnedByUser(ctx *gin.Context, ID int64) (db.Account, error) {
